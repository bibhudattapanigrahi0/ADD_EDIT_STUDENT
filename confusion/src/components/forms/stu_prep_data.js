    ...
    return (
      <Form
        ...
        onSubmit={(global_form) => {
          axios
            .post(` http://localhost:8000`, global_form.stu_prep_data)
            .then((res) => {
              console.log(res);
      ...
      >
        <Row className="form-group">
          <Label htmlFor=".stu_prep_data.admn_no" md={2}>
            admission_no
          </Label>
          <Col md={10}>
            <Control.text
              model=".stu_prep_data.admn_no"
              id="admn_no"
              name="admn_no"
        ...
        <Row className="form-group">
          <Label htmlFor=".stu_prep_data.session_year" md={2}>
            session_year
          </Label>
          <Col md={10}>
            <Control.text
              model=".stu_prep_data.session_year"
              id="session_year"
              name="session_year"
