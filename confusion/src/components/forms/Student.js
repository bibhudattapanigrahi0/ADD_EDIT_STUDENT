    ...
    return (
      <Form
        ...
        onSubmit={(global_form) => {
          axios
            .post(` http://localhost:8000`, global_form.student)
            .then((res) => {
              console.log(res);
      ...
      >
        <Row className="form-group">
          <Label htmlFor=".student.admn_no" md={2}>
            admission_no
          </Label>
          <Col md={10}>
            <Control.text
              model=".student.admn_no"
              id="admn_no"
              name="admn_no"
        ...
        <Row className="form-group">
          <Label htmlFor=".student.course_id" md={2}>
            course_id
          </Label>
          <Col md={10}>
            <Control.text
        ...
        <Row className="form-group">
          <Label htmlFor=".student.branch_id" md={2}>
            branch_id
          </Label>
          <Col md={10}>
            <Control.text
              model=".student.branch_id"
              id="branch_id"
              name="brnch_id"
