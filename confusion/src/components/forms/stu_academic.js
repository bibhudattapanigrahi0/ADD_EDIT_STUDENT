  ...
  render() {
    return (
      ...
      >
        ...
        <Row className="form-group">
          <Label htmlFor=".stu_acad.auth_id" md={2}>
            auth_id
          </Label>
          <Col md={10}>
            <Control.text
        ...
        <Row className="form-group">
          <Label htmlFor=".stu_acad.enroll_year" md={2}>
            enroll_year
          </Label>
          <Col md={10}>
            <Control.text
        ...
        <Row className="form-group">
          <Label htmlFor=".stu_acad.iit_jee_rank" md={2}>
            iit_jee_rank
          </Label>
          <Col md={10}>
            <Control.text
        ...
        <Row className="form-group">
          <Label htmlFor=".stu_acad.iit_jee_cat_rank" md={2}>
            iit_jee_cat_rank
          </Label>
          <Col md={10}>
            <Control.text
        ...
        <Row className="form-group">
          <Label htmlFor=".stu_acad.cat_score" md={2}>
            cat_score
          </Label>
          <Col md={10}>
            <Control.text
        ...
        <Row className="form-group">
          <Label htmlFor=".stu_acad.gate_score" md={2}>
            gate_score
          </Label>
          <Col md={10}>
            <Control.text
        ...
        <Row className="form-group">
          <Label htmlFor=".stu_acad.course_id" md={2}>
            course_id
          </Label>
          <Col md={10}>
            <Control.text
        ...
        <Row className="form-group">
          <Label htmlFor=".stu_acad.branch_id" md={2}>
            branch_id
          </Label>
          <Col md={10}>
            <Control.text
        ...
        <Row className="form-group">
          <Label htmlFor=".stu_acad.other_rank" md={2}>
            other_rank
          </Label>
          <Col md={10}>
            <Control.text
              model=".stu_acad.other_rank"
              id="other_rank"
              name="other_rank"
